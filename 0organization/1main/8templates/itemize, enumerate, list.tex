% On the Error "Command \labelindent already defined": That's a thing only in certain Class-Files (like IEEE) for legacy reasons. You may safely deactivate it with:
